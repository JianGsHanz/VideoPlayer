...
public class CacheIjkVideoView extends IjkVideoView {
    ...
    public CacheIjkVideoView(@NonNull Context context,  AttributeSet attrs) {
        super(context, attrs);
    }

    public CacheIjkVideoView(@NonNull Context context,  AttributeSet attrs, int defStyleAttr) {
